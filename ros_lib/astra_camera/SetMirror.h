#ifndef _ROS_SERVICE_SetMirror_h
#define _ROS_SERVICE_SetMirror_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETMIRROR[] = "astra_camera/SetMirror";

  class SetMirrorRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETMIRROR; };
    virtual const char * getMD5() override { return "8c1211af706069c994c06e00eb59ac9e"; };

  };

  class SetMirrorResponse : public ros::Msg
  {
    public:

#ifndef _ROS_SERVICE_SetAeEnable_h
#define _ROS_SERVICE_SetAeEnable_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETAEENABLE[] = "astra_camera/SetAeEnable";

  class SetAeEnableRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETAEENABLE; };
    virtual const char * getMD5() override { return "8c1211af706069c994c06e00eb59ac9e"; };

  };

  class SetAeEnableResponse : public ros::Msg
  {
    public:
